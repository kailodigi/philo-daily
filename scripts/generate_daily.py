...
SEARCH_PLANS = (
    {
        ...
        "sites": (
            ...
            "sec.gov", "pbc.gov.cn", "gov.cn", "csrc.gov.cn", "sse.com.cn",
            "szse.cn", "hkex.com.hk", "news.cn", "amazon.com", "microsoft.com",
            "wsj.com", "cnbc.com", "apnews.com", "spglobal.com", "nasdaq.com",
    ...
    },
    {
        ...
        "sites": (
            ...
            "about.fb.com", "blog.youtube", "x.com", "reuters.com",
            "bloomberg.com", "ft.com", "news.cn", "gov.cn", "semiwiki.com",
            "techcrunch.com", "theverge.com", "apnews.com",
        ),
    },
)
...
def call_dashscope_json(
    *,
    ...
    ledger: UsageLedger,
    search_enabled: bool,
    assigned_sites: tuple[str, ...] | None = None,
    ...
    for attempt in range(2):
        ...
        try:
            ...
            if search_enabled:
                ...
                if assigned_sites:
                    kwargs["search_options"]["assigned_site_list"] = list(
                        assigned_sites
                    )
...
"""
    ...
    for source_id, item in selected.selections.items():
        if not re.fullmatch(r"[FAS]\d+", source_id):
